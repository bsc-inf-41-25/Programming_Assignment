...
int main(){
    ...
    *pPointer = 10; //assign a value to the first element 
    ...
    /*increment the pointer using pointer arithmetic to assign the address of the seconf element to the pointer*/
    pPointer++;
    ...
    *pPointer = 40; //assign a value to the fourth element 
    ...
    //assign the address to the first element to the pointer
    pPointer = numbersArray;
    /*assign a value to the fifth element using indirection and pointer pointer arithmentic */
